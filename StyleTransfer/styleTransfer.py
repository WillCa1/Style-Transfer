...
def postp(tensor):  #Clip results in the range [0,1]
    t = postpa(tensor)
    t[t > 1] = 1
    t[t < 0] = 0
    img = postpb(t)
...
plt.imsave('res1.jpg', out_img)
plt.savefig('ress1.jpg')
plt.show()
...
plt.gcf().set_size_inches(10, 10)
plt.imsave('res2.jpg', out_img_hr)
plt.savefig('ress2.jpg')
plt.show()
